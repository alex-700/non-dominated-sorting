...
public final class JensenFortinBuzdalov {
    ...
    public static NonDominatedSortingFactory getRedBlackTreeSweepHybridENSHeuristicImplementation(int allowedThreads) {
        return (p, d) -> new JFBDoubleHeuristic(new RedBlackRankQueryStructure(p), d, allowedThreads, new ENS(100, 200));
    }
